...
import { FaShieldAlt, FaDownload, FaPlay, FaCheck } from "react-icons/fa";
    ...
    <div className="app">
      <header className="header">
        <div className="header-content">
          ...
          <a href="https://github.com/cedricicic/Promptection/archive/refs/heads/main.zip" className="install-button">
      ...
      <main className="main">
        <div className="hero">
          <h2>Protect Your sensetive data from AI chatbots</h2>
          <p>
            Promptection is a Chrome extension that automatically detects and redacts sensitive information before it’s sent
          </p>
        </div>
        ...
        <div className="features">
          <div className="feature-card">
            ...
            <p>
            Uses powerful regex patterns to catch emails, credit cards, SSNs, and more.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              Works seamlessly with popular AI platforms and chatbots such as ChatGPT, Claude and DeepSeek.
            </p>
          </div>
